...
Company (корпоративный клиент)
   ...
   ↓ опционально: интегрирует Bitrix24 для автоимпорта сотрудников
Platform
   ↓ предоставляет сотрудникам аккаунты с планами
Employees (STANDARD / PLUS / PRO)
   ↓ получают promo codes
   ↓ используют коды у мерчантов (онлайн или офлайн)
   ↓ могут активировать промокоды через Telegram-бот
Merchants
   ↓ предоставляют скидки по promo codes
```
