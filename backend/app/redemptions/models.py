...
class BenefitRedemption(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    promo_code: Mapped[PromoCode | None] = relationship(back_populates="redemption", uselist=False)
    ...
    def __repr__(self) -> str:
        return f"<BenefitRedemption employee={self.employee_id} benefit={self.benefit_id} status={self.status}>"
